...
# 안될 경우 아래 변수 세팅 실행 후 다시 설치
#Sys.setenv(JAVA_HOME="/Library/Java/JavaVirtualMachines/jdk1.8.0_191.jdk/Contents/Home/jre") # 본인 PC경로로 세팅해준다.
#dyn.load('/Library/Java/JavaVirtualMachines/jdk1.8.0_191.jdk/Contents/Home/jre/lib/server/libjvm.dylib') # 본인 PC경로로 세팅해준다.
